                                            ...
                                            <?php foreach ($members as $member) : ?>
                                                <li class="media d-flex">
                                                    ...
                                                    <div class="media-right">
                                                        <?php if ($member['user_id'] != $project['owner'] && LEADER != $member['role']) : ?>
                                                            <div class="dropdown-secondary dropdown d-inline-block" id="context-menu">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdown3" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                    <?php if (LEADER != $member['role']) : ?>
                                                                        <a class="dropdown-item waves-light waves-effect" onclick="changeRoleToLeader(<?= $member['project_user_id'] ?>)">Thăng trưởng nhóm</a>
                                                                    <?php else : ?>
                                                                        <a class="dropdown-item waves-light waves-effect" onclick="changeRoleToMember(<?= $member['project_user_id'] ?>)">Về thành viên</a>
                                                                    <?php endif ?>
...
<script>
    ...
    function changeRoleToLeader(projectUserId) {
