                                ...
                                <div class="card-block">
                                    <div class="row align-items-end">
                                        <div class="col-8">
                                            ...
                                            <h6 class="text-white m-b-0">Dự án</h6>
                                        </div>
                                ...
                                <div class="card-block">
                                    <div class="row align-items-end">
                                        <div class="col-8">
                                            ...
                                            <h6 class="text-white m-b-0">Công việc</h6>
                                        </div>
                                        <div class="col-4 text-right">
                                ...
                                <div class="card-block">
                                    <div class="row align-items-end">
                                        <div class="col-8">
                                            ...
                                            <h6 class="text-white m-b-0">Công việc đang thực hiện</h6>
                                        </div>
                                        <div class="col-4 text-right">
                                ...
                                <div class="card-block">
                                    <div class="row align-items-end">
                                        <div class="col-8">
                                            ...
                                            <h6 class="text-white m-b-0">Công việc đã hoàn thành</h6>
                                        </div>
                                        <div class="col-4 text-right">
