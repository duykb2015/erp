...
<head>
    ...
    <!-- simple line icon -->
    <link rel="stylesheet" type="text/css" href="libraries\assets\icon\simple-line-icons\css\simple-line-icons.css">
...
<![endif]-->
    ...
    <!-- counter js -->
    <script src="libraries\bower_components\countdown\js\jquery.countdown.js"></script>
    <script src="libraries\assets\pages\counter\task-detail.js"></script>
    <!-- Switch component js -->
    <script type="text/javascript" src="libraries\bower_components\switchery\js\switchery.min.js"></script>
    <!-- i18next.min.js -->
...
<!-- D:/Dev/summoner-war/public/templates/admin/adminty_dashboard/slider.htm -->
</script>
</body>
